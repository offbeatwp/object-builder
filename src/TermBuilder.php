...
//            if ($data) {
//                if ($data['single'] && isset($data['oldValue'])) {
//                    update_term_meta($this->id, $key, $data['value'], $data['oldValue']);
//                } else {
//                    add_term_meta($this->id, $key, $data['value'], $data['single']);
//                }
//            } else {
...
//    }
     ...
     * @return TermBuilder
     */
    public static function update($term): TermBuilder
    {
        $term = TermBuilder::getWpTerm($term);
    ...
    public function save(): int
    {
        ...
        // Copy posts from the original term to the new term
        // TODO: Do we want this? Probably?
